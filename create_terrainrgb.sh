...
mbtiles=${OUTPUT_DIR}/jaxa_swiss_italy_terrainrgb_z5-Z14_webp_lanczos.mbtiles
...
sqlite3 ${mbtiles} 'UPDATE metadata SET value = "jaxa_swiss_italy_terrainrgb_z5-Z14_webp" WHERE name = "name" AND value = "";'
