...
france1=${OUTPUT_DIR}/france.vrt
france2=${OUTPUT_DIR}/france_warp.vrt
swiss1=${OUTPUT_DIR}/swiss.vrt
swiss2=${OUTPUT_DIR}/swiss_warp.vrt
outvrt=${OUTPUT_DIR}/out.vrt
mbtiles=${OUTPUT_DIR}/jaxa_swiss_italy_france_terrainrgb_z5-Z14_webp_lanczos.mbtiles
...
#gdalbuildvrt -overwrite -resolution highest -r lanczos -te -12 30.0 25.0 56.0 -srcnodata -9999 -vrtnodata -9999 ${jaxavrt1} ${JAXA_INPUT_DIR}/*_DSM.tif
gdalbuildvrt -overwrite -resolution highest -r lanczos -te -11.26 31.94 22.6 55.78 -srcnodata -9999 -vrtnodata -9999 ${jaxavrt1} ${JAXA_INPUT_DIR}/*_DSM.tif
...
#France VRT
gdalbuildvrt -overwrite -resolution highest -r lanczos ${france1} ${FRANCE_INPUT_DIR}/*.vrt
gdalwarp -r lanczos -t_srs EPSG:3857 -dstnodata 0 ${france1} ${france2}
...
rio rgbify -b -10000 -i 0.1 --min-z 5 --max-z 14 -j 24 --format webp ${outvrt} ${mbtiles}
...
sqlite3 ${mbtiles} 'UPDATE metadata SET value = "JAXA AW3D30 (2024), swissALTI3D (2024), and Tinitaly  (2023), and RGE Alti (2024) converted with rio rgbify" WHERE name = "description";'
...
sqlite3 ${mbtiles} "INSERT INTO metadata (name,value) VALUES('attribution','<a href=https://earth.jaxa.jp/en/data/policy/>JAXA AW3D30 (2024)</a> | <a href=https://www.swisstopo.admin.ch/en/height-model-swissalti3d>swissALTI3D (2024)</a>'); | <a href=https://tinitaly.pi.ingv.it/>Tinitaly (2023)</a> | <a href=https://geoservices.ign.fr/rgealti>RGE ALTI (2024)</a>');"
sqlite3 ${mbtiles} "INSERT INTO metadata (name,value) VALUES('minzoom','5');"
sqlite3 ${mbtiles} "INSERT INTO metadata (name,value) VALUES('maxzoom','14');"
sqlite3 ${mbtiles} "INSERT INTO metadata (name,value) VALUES('bounds','-180,-90,180,90');"
sqlite3 ${mbtiles} "INSERT INTO metadata (name,value) VALUES('center','0,0,10');"
